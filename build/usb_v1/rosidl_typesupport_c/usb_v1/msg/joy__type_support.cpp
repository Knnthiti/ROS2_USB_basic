...
static const _Joy_type_support_symbol_names_t _Joy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_v1, msg, Joy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usb_v1, msg, Joy)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usb_v1, msg, Joy)() {
  return &::usb_v1::msg::rosidl_typesupport_c::Joy_message_type_support_handle;
}
